 ...
 *  contaoConstraint: string,
 *  contaoVersions: string
 * }
 */
class Package
{
    ...
    private string|null $replacedBy = null;
    ...
    public function getReplacedBy(): string|null
    {
        return $this->replacedBy;
    }

    public function setAbandoned(bool $abandoned, string|null $replacedBy = null): self
    {
