...
namespace Contao\PackageList\Indexer;
...
class MetaDataRepository
{
    ...
    public function __construct(
        ...
        #[Autowire('%kernel.project_dir%/var/metadata/meta')] private readonly string $metaDataDir,
    ) {
    }
    ...
    public function getLogoForPackage(Package $package): string|null
    {
        ...
        if (!$this->filesystem->exists($this->getMetaDataDir().'/'.$image)) {
