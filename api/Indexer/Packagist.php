...
class Packagist
{
    private const string PLATFORM_PACKAGE_REGEX = '{^(?:php(?:-64bit|-ipv6|-zts|-debug)?|hhvm|(?:ext|lib)-[^/ ]+)$}i';

    /**
     * Excluded packages that should not be found.
     */
    private const array EXCLUDE_LIST = ['contao/installation-bundle', 'contao/contao'];
