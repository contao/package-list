    ...
    <main-layout>
        ...
        <div class="package-search">
            ...
            <div class="package-search__more">
                <loading-button inline icon="search" :loading="searching" v-if="hasMore && results" @click="loadMore">{{ $t('ui.packagesearch.more') }}</loading-button>
            </div>
...
<script>
    ...
    export default {
        components: { MainLayout, SearchPackage, Loader, LoadingButton },
