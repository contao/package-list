<template>
    <section class="search-bar">
        <input class="search-bar__input" ref="search" id="search" type="text" :placeholder="placeholder" autocomplete="off" :value="query" @input="searchInput" @keypress.esc.prevent="stopSearch">
